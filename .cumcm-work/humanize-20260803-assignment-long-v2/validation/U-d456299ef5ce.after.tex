...
探索与相关 & Pearson、Spearman、Kendall、分布和关联图形展示 & 组员2 & 假设条件、显著性/效应量和非因果声明\\
聚类 & K-Means、DBSCAN、层次聚类、谱聚类 & 组员2 & 合成样例、簇稳定性和业务解释\\
插值与降维 & Lagrange、三次样条、Kriging；PCA、t-SNE、UMAP & 组员2 & 留点误差、解释方差、图形展示边界\\
样本筛选 & Monte Carlo 随机抽样 & 组员2（与组员1共享输入输出关系） & 固定种子、抽样分布、覆盖率和偏差审计\\
