...
- **2.9.2** - Added academic and mathematical-modeling routing boundaries, prohibited automatic editor chaining, and required explicit protected spans before in-place edits of TeX, math, code, labels, citations, units, or result literals. No change to the 33 patterns.
