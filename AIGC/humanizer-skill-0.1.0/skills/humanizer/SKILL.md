---
name: humanizer-voice-profile
description: Edit general English prose with one of five explicit voice profiles while preserving source facts. Use only when the user wants a casual, professional, technical, warm, or blunt nonacademic candidate. Route academic, CUMCM, Chinese, and TeX work through $aigc-writing-router; never use detector scores as the acceptance criterion.
---
