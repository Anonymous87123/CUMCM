---
name: humanizer-medical-academic
description: Edit English medical manuscripts with the bundled author-profile and two-pass academic workflow. Use explicitly for medical English only. Route Chinese, CUMCM, general TeX, and nonmedical academic work through $aigc-writing-router. Preserve scientific claims, data, citations, equations, and named constructs.
---
