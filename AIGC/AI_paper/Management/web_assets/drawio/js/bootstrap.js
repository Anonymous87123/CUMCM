...
else
{
    (function()
    {
        ...
        function appLoadFailed(message, e)
        {
            mxscript('js/integrate.min.js', appLoaded, null, null, false, function(fallbackMessage, fallbackError)
            {
                var status = document.getElementById('geStatus');

                if (status != null)
                {
                    status.innerHTML = 'Page could not be loaded. Missing draw.io application bundle.';
                }

                if (typeof console !== 'undefined' && console.error != null)
                {
                    console.error(message, e);
                    console.error(fallbackMessage, fallbackError);
                }
            });
        }
        ...
        function loadAppJS()
        {
            mxscript('js/app.min.js', appLoaded, null, null, false, appLoadFailed);
        };
