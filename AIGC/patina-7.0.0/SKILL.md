---
name: patina
description: Detect and rewrite AI writing patterns in Korean, English, Chinese, and Japanese text with semantic-anchor, MPS, and fidelity checks. Use for ordinary prose or read-only academic prose audits. For TeX, accept only an extracted prose proxy; never alter authority formulas, commands, citations, numbers, or labels. Route CUMCM content and final selection through $aigc-writing-router.
---
