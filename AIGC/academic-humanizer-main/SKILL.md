...
description: Improve the clarity and voice of English academic writing (papers, theses, rebuttals, and proposals) while preserving scholarly conventions, claim-evidence alignment, the author's voice, every number, result, equation, and citation. Use explicitly for English academic prose; route Chinese, CUMCM, and medical-English work through $aigc-writing-router.
---
