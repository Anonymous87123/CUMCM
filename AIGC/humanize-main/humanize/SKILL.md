---
name: humanize-english-editor
description: >
  Edit general English prose through the bundled source-bound rewrite protocol.
  Use explicitly when the user wants this editor's structural and rhetorical audit.
  Do not use for academic, CUMCM, Chinese, or TeX documents; route those tasks through
  $aigc-writing-router. Preserve source facts and do not optimize for detector scores.
---
