---
name: humanize-chinese-copy-lab
description: Run the bundled candidate-and-local-scorer laboratory for general Chinese communication copy such as email, chat, support, marketing, and community notices. Use explicitly when the visible baseline/challenger/repair report is wanted. Do not use for academic, CUMCM, TeX, mathematical, or evidence-constrained writing; route those through $aigc-writing-router.
---
