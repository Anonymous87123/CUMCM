---
name: humanizer-brandonwise
description: Detect and edit patterns in general English prose using the bundled pattern detectors and statistical report. Use explicitly for nonacademic English diagnostics or one source-bound candidate. Do not use as the academic, CUMCM, Chinese, or TeX authority; route those tasks through $aigc-writing-router.
---
